...
import { challengeTypes, getChallengeTypeInfo } from '../utils/challengeHelpers';
...
const HomeScreen = () => {
  ...
  const handleCreateChallenge = async () => {
    console.log('🎯 Création défi depuis HomeScreen:', formData);
            ...
            <View style={styles.challengeHeader}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.challengeTitle}>
                  {getChallengeShortLabel(activeChallenge)}
                </Text>
